...
export default function RepairabilitySection() {
  return (
    <section className="bg-gradient-to-br from-[#1E4ED8] to-[#2563EB] flex flex-col lg:flex-row relative overflow-hidden">
      ...
      {/* Left Text Content */}
      <div className="w-full lg:w-1/2 flex lg:justify-end py-10 md:py-12 px-4 sm:px-6 md:px-12 relative z-10">
        <div className="w-full max-w-[600px] lg:pr-12 space-y-6 text-white">
          
          <div className="flex items-center gap-4 mb-2">
            <div className="w-[40px] md:w-[80px] h-[3px] bg-gradient-to-r from-transparent to-white rounded-l-full opacity-80"></div>
            <div className="w-2 h-2 rotate-45 bg-white shadow-[0_0_8px_rgba(255,255,255,0.8)]"></div>
            <div className="text-[10px] md:text-[11px] font-bold uppercase tracking-[0.2em] opacity-90 sm:whitespace-nowrap pl-2">
              HOT TOPICS
            </div>
          </div>

          <h2 className="text-2xl md:text-4xl lg:text-5xl font-black tracking-tight pb-4 drop-shadow-md leading-[1.2] md:leading-[1.1]">
            Repairability
          </h2>
      ...
      <div className="w-full lg:w-1/2 relative flex items-center justify-center p-6 lg:p-0 lg:pr-12 lg:py-12 z-10">
        <div className="relative w-full max-w-[800px] rounded-2xl overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] border border-white/10 hover:md:scale-[1.02] transition-transform duration-700 hover:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.6)] bg-[#9CB4D4]">
