...
import { SITE_SECTION_HEADING_CLASS, SITE_SECTION_HEADING_STYLE } from "@/components/home/HomeContent";
    ...
    <section className="bg-white py-12 md:py-16 lg:py-24">
      <div className={CAREERS_SECTION_SHELL}>
        <div className={`${CAREERS_CONTENT_WIDTH} flex flex-col items-center text-center`}>
          ...
          <h2
            className={`mt-8 max-w-4xl text-[#1A1A1A] sm:mt-10 ${SITE_SECTION_HEADING_CLASS}`}
