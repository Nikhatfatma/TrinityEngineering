      ...
      >
        <div className={`${FORTIFIED_CONTENT_WIDTH} text-center`}>
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:mt-10 sm:flex-row sm:gap-4">
            <span className="inline-flex min-w-[10.5rem] items-center justify-center rounded-md bg-[#0047AB] px-7 py-2.5 text-[11px] font-bold sm:min-w-[11.5rem] sm:px-8 sm:py-3 sm:text-sm md:text-base">
              {FORTIFIED_HERO.primaryCta.label}
            </span>
            <span className="inline-flex min-w-[10.5rem] items-center justify-center rounded-md border-2 border-white bg-black/25 px-7 py-2.5 text-[11px] font-bold text-white sm:min-w-[11.5rem] sm:px-8 sm:py-3 sm:text-sm md:text-base">
